...
function the_block_render_navbar_3( $X ) {
...
$navbar = '<nav class="mr-auto"></nav>'; // Fallback if no menu selected
if ( has_nav_menu( 'navbar' ) ) {
  $navbar = wp_nav_menu( array(
    'theme_location' => 'navbar',
    'menu_class'     => 'nav nav-navbar mr-auto',
    'container'      => '',
...
$buttons = '';
if ( ! $X['navbar']['hideBtn1'] || ! $X['navbar']['hideBtn2'] ) {
  $buttons .= '<div class="navbar_buttons">';
